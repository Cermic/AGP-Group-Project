...
void Utilities::loadUtilities()
	{
		...
		phong2LTextureProgram = rt3d::initShaders("../shaders/vertex/phong-tex-2L.vert", "../shaders/fragment/phong-tex-2L.frag");
		...
		lightMap2LProgram = rt3d::initShaders("../shaders/vertex/lightmap2L.vert", "../shaders/fragment/lightmap2L.frag");
		//Setting up lightMapProgram
		...
		//Sets up the shader that combines normal mapping and lightmapping
		combinedTextureProgram = rt3d::initShaders("../shaders/vertex/combined.vert", "../shaders/fragment/combined.frag");
		...
		shadowProgram = rt3d::initShaders("../shaders/vertex/phong-shadow.vert", "../shaders/fragment/phong-shadow.frag");
		//Setting up shadowProgram
		depthProgram = rt3d::initShaders("../shaders/vertex/basicDepthShader.vert", "../shaders/fragment/basicDepthShader.frag");
		...
		particleProgram = rt3d::initShaders("../shaders/vertex/particle.vert", "../shaders/fragment/particle.frag");
