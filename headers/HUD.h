...
public:
	...
	void draw(stack<glm::mat4> mvStack, int value, GLuint shaderProgram, string labelText); // draw method that takes the stack, the specular value of the light and a shader.
